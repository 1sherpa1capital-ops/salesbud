...
| **Email threading** | `email-threading` | Maintaining conversation threads, replying to emails with proper headers (Message-ID, In-Reply-To, References) |
...
**Need to maintain email conversation threads?** Use `email-threading` skill
- Sending replies that appear threaded in Gmail/Outlook
- Setting Message-ID, In-Reply-To, and References headers
- Handling webhook replies with proper threading
